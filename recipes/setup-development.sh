...
$SCRIPT_PATH/parts/shared/require.sh -n"oxid-esales/apex-theme" -v"dev-b-7.6.x"
...
# Register the component to the main services.yaml file, as we dont have component Activation process
perl -ni\
  -e 'print; print "  -\n    resource: ../../services.yaml\n" if eof'\
  source/var/generated/generated_services.yaml
